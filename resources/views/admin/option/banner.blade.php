                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="{{ route('admin.option.banner') }}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>chọn số lượng banner</label>
                            ...
                            @if (!empty($sliderBannerOld))
                                @if ($sliderBannerOld)
                                    <form id="deleteForm"
                                        action="{{ route('admin.option.deletePower', $sliderBannerOld->key) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                @endif
